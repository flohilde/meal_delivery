...
<a name="readme-top"></a>
<!--
*** Taken from the Best-README-Template.
-->
...
To get started, just clone the project, install the required packages, and run main.py.

### Installation

1. Clone the repo
   ```sh
   git clone https://github.com/flohilde/meal_delivery.git
   ```
...
A simulation can be started by running ./src/main.py
...
Florentin Hildebrandt - [@ovgu](https://www.ms.ovgu.de/Team/Florentin+Hildebrandt.html)

Project Link: [https://github.com/flohilde/meal_delivery](https://github.com/flohilde/meal_delivery)
